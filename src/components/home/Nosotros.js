            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style={{minHeight: "400px"}}>
                    <div className="position-relative h-100">
                        <img className="img-fluid position-absolute w-100 h-100" src="img/profilepic.jpg" alt="mind" style={{objectFit: "cover"}}/>
                    </div>
                </div>
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 className="section-title bg-white text-start text-primary pe-3">Sobre Mi</h6>
                    <h1 className="mb-4">Bienvenidos a Mindfulness</h1>
                    ...
                    <Link className="btn btn-primary py-3 px-5 mt-2" to="/about">Leer Más</Link>
                </div>
            </div>
        </div>
    </div>
